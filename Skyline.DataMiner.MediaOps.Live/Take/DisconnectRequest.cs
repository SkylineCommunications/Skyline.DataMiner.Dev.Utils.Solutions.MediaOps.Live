namespace Skyline.DataMiner.MediaOps.Live.Take
{
	...
	/// <summary>
	/// Represents a request to disconnect a destination endpoint.
	/// </summary>
	public class DisconnectRequest
	{
		...
		/// <exception cref="ArgumentException">Thrown when the destination endpoint doesn't have the 'Destination' role.</exception>
