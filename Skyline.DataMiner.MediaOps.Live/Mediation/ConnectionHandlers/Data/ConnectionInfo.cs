namespace Skyline.DataMiner.MediaOps.Live.Mediation.ConnectionHandlers.Data
{
	...
	/// <summary>
	/// Contains information about a connection between a source and destination endpoint.
	/// </summary>
	public class ConnectionInfo
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ConnectionInfo"/> class from endpoint instances.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the source endpoint information. Can be null when the destination is disconnected.
		/// </summary>
