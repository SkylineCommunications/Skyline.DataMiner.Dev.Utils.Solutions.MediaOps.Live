namespace Skyline.DataMiner.MediaOps.Live.API.Repositories.Orchestration
{
	...
	internal class OrchestrationEventRepository : Repository<OrchestrationEvent>
	{
		...
		/// <param name="connection">Api that calls the repository.</param>
		internal OrchestrationEventRepository(SlcOrchestrationHelper helper, IConnection connection) : base(helper, connection)
		{
		}
